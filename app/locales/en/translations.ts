...
export default {
    ...
    general: {
        ...
        help: 'Help',
        api: 'API',
        cos: 'McGill University',
        home: 'Home',
        period: '.',
        settings: 'Settings',
        project: 'project',
        component: 'component',
        hosted_on_the_osf: 'Hosted on ... ',
    ...
    file_browser: {
        ...
        info: {
            ...
            folders: '<b>Folders:</b> Not supported; consider an NeuroHub project for uploading and managing many files.',
            open1: '<b>Open files:</b> Click a file name to view the file on NeuroHub.',
    ...
    dashboard: {
        ...
        meetings: {
            ...
            description: 'Use the NeuroHub for Meetings service to provide a central location for conference submissions.',
            button: 'View meetings',
        },
        preprints: {
            title: 'Browse the latest research',
            description: 'Check out the latest preprints on HeuroHub covering a variety of research areas.',
    ...
    banners: {
        ...
        view_only: {
            warning: 'You are viewing NeuroHub through a view-only link, which may limit the data you have permission to see.',
            view_normally: 'Leave this view',
        },
    },
    move_to_project: {
        create_new_project: 'Create new public project',
        connect_to_existing: 'Connect file to existing NeuroHub project',
        ...
        convert_or_copy_message: {
            project: 'Clicking "Move file" will immediately make changes to your NeuroHub project and move your file.',
            component: 'Clicking "Move file" will immediately make changes to your NeuroHub component and move your file.',
        },
    ...
    support: {
        title: 'Support',
        faq_title: 'NeuroHub FAQ is under construction.',
        faq_paragraph: 'NeuroHub is build on OSF, so meanwhile check OSF FAQ <a href="{{faqPageUrl}}" data-analytics-name="faq_link">FAQ page</a>.',
        faq_button: 'Visit FAQ',
        guides_title: 'Guides',
        guides_paragraph: 'Learn how to improve your research workflow. Read our <a href="{{helpUrl}}" data-analytics-name="guides_link">guides</a> for step-by-step screenshots that show you the basics of project structures, version control, privacy, files, add-on support, and more!',
        ...
        consultation_title: 'Are you looking for consulting and hands-on training?',
        consultation_paragraph: 'McGill HBHL consult on use NeuroHub and best practices. To learn more about this service</a>.',
        social_title: 'Other ways to get help',
        social_twitter: 'Ask us a question on OSF Twitter',
        social_mailing: 'Join OSF mailing list',
        social_facebook: 'Follow OSF on Facebook',
    ...
    not_found: {
        ...
        registries: {
            contact: 'support@neurohub.mcgill.ca',
            go_to: 'Go to NeuroHub Registries',
            line1: 'The page you were looking for is not found on the NeuroHub Registries service.',
    ...
    home: {
        ...
        features_archive_paragraph: 'Computer or collaborator explode? With NeuroHub <strong>you will never lose your project data.</strong>',
        ...
        features_workflow_paragraph: 'NeuroHub helps individuals, teams and labs make their <strong>research processes more efficient.</strong>',
        ...
        global_paragraph: 'Labs and teams across the globe use OSF which powers NeuroHub',
        global_link: 'right here.',
        global_label: 'Get involved',
        non_profit_title: 'We are a <strong>mission-driven non-profit</strong>',
        non_profit_paragraph1: 'HBHL NeuroHub is a free, open source service of the',
        non_profit_link: 'McGill University.',
        ...
        users_title: '<strong>Profs, researchers, and teams rely</strong> on NeuroHub',
        ...
        free_title2: 'This tool good built to support your research.',
        free_link: 'Get started',
        learn_more: 'Learn more',
    },
    'new-home': {
        'support-section': {
            header: 'NeuroHub Features',
            arrow: 'arrow',
            search: {
            ...
            analyze: {
                ...
                description: 'Store data, code, and other materials in NeuroHub/OSF Storage, or connect your Dropbox or other third-party account. Every file gets a unique, persistent URL for citing and sharing.',
            },
            publish: {
                header: 'Publish Your Reports',
                description: 'Share papers in NeuroHub Preprints or a community-based preprint provider, so others can find and cite your work. Track impact with metrics like downloads and view counts.',
            },
        },
        testimonials: {
            heading: 'It is build on OSF Center for Open Science framework',
        ...
        'integrations-section': {
            header: 'Neurohub integrations make your workflow more efficient',
    ...
    settings: {
        ...
        'developer-apps': {
            ...
            explanation: 'The NeuroHub allows third-party web applications to connect to the NeuroHub on behalf of other users via the OAuth 2.0 web application flow.',
            ...
            clientSecretDescription: 'The client secret is known only to you and NeuroHub. Do not display or expose it to others.',
